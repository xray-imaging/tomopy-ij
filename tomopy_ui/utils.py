...
class PaganinSelection(event.ItemListener):
    ...
    def itemStateChanged(self, event):
        ...
        if self.fields.paganinBox.isSelected() == True:
            ...
            self.fields.resolutionLabel.setVisible(True)
            self.fields.resolutionField.setVisible(True)
            self.fields.resolutionUnitsLabel.setVisible(True)
            ...
            self.fields.resolutionLabel.setVisible(False)
            self.fields.resolutionField.setVisible(False)
            self.fields.resolutionUnitsLabel.setVisible(False)
